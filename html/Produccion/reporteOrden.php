    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col col-sm-12 col-md-12 col-lg-8 col-xl-8 m-0">
                ...
                <a href="ordenesPDF.php" class="boton perz">Generar PDF</a>
                <a href="ordenesEXCEL.php" class="boton perz">Generar Excel</a>
                    ...
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>Cantidad de Pizza</th>
                                <th>Total de la Pizza</th>
                                <th>Precio de la Orden</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            $ret = mysqli_query($con, "SELECT * FROM orden_prod");
                            if ($ret && mysqli_num_rows($ret) > 0) {
                                while ($row = mysqli_fetch_assoc($ret)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $row['FechaGeneracion']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row['NombrePizza']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row['Cantidad_Pizza']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row['Total_Pizza']; ?> $
                                        </td>
                                        <td>
                                            <?php echo $row['Precio_Orden']; ?> $
                                        </td>
                                    </tr>
                                    <?php
                                }
                                ...
                                ?>
                                <tr>
                                    <td colspan="6">No hay registros encontrados</td>
                                </tr>
                                <?php
                            }
                            ?>
